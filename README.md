...
![André Luiz](https://github.com/user-attachments/assets/fecee851-9f62-41db-8e71-b240d92ef861)

## Introdução

Olá! Meu nome é **André Luiz**, tenho 25 anos e sou natural de São José dos Campos, São Paulo.  
Atualmente, estou cursando **Tecnologia em Banco de Dados** na **FATEC São José dos Campos** e trabalho como **Desenvolvedor RPA Júnior na Bernhoeft**.

Sempre tive facilidade com tecnologia e interesse por sistemas e automações. Esse interesse foi se fortalecendo ao longo do tempo, especialmente com o incentivo da minha namorada, que me motivou a entrar de vez na área de TI.  
A escolha pelo curso de Banco de Dados na FATEC veio justamente pela combinação entre minha afinidade com a tecnologia e a qualidade reconhecida da instituição.

Antes de atuar como desenvolvedor, trabalhei como assistente administrativo na mesma empresa. Essa experiência, embora fora da área técnica, me ajudou a compreender melhor os processos internos e, mais tarde, foi essencial para minha transição.  
O ambiente de trabalho também foi um diferencial: tive a oportunidade de aplicar e aprimorar meus conhecimentos em tecnologia, o que reforçou ainda mais minha decisão de seguir carreira na área.
...
* [GitHub](https://github.com/Andre-Bernardes200)  
* [E-mail](mailto:andreluiz1088@hotmail.com)

---

## Meus Principais Conhecimentos

Sou apaixonado por desenvolvimento back-end, mas também possuo conhecimento sólido em front-end e infraestrutura.  
Entre todos os meus conhecimentos, destaco:
...
**Problema:**  
Havia dificuldade em realizar a distribuição e acompanhamento de feedbacks e pontuações dentro das equipes de forma organizada e rastreável.

**Solução:**  
Foi desenvolvido um sistema via linha de comando para gestão 360° de feedbacks e distribuição de pontos entre membros de equipes, garantindo maior transparência e controle.

![Aval360](https://github.com/user-attachments/assets/8c7f97f8-d393-4fa2-a33f-b28cae9bc1a5)
...
Como master do projeto, foquei na implementação dos rituais ágeis. Utilizei o ClickUp como ferramenta central para o gerenciamento detalhado das tarefas, incluindo o rigoroso acompanhamento de datas e descritivos. O burndown chart da equipe foi montado e acompanhado diretamente dentro do ClickUp para dar visibilidade ao progresso. Para o acompanhamento da equipe, instituí Dailys (com cadência às segundas, quartas e sextas) e utilizei uma tabela em Excel dedicada para registrar as avaliações de performance e lições aprendidas ao final de cada sprint.
